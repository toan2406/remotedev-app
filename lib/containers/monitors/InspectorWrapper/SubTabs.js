...
var _ActionTree = require('./ActionTree');

var _ActionTree2 = _interopRequireDefault(_ActionTree);
...
var SubTabs = function (_Component) {
  ...
  _createClass(SubTabs, [{
    ...
    value: function updateTabs(props) {
      ...
      this.tabs = [{
        name: 'Tree',
        component: parentTab === 'Action' ? _ActionTree2.default : _StateTree2.default,
        selector: function selector() {
          return _this2.props;
        }
      }, {
