...
var _MockTab = require('./MockTab');

var _MockTab2 = _interopRequireDefault(_MockTab);

var _apiCallDebugTransform = require('../../../utils/apiCallDebugTransform');

var _apiCallDebugTransform2 = _interopRequireDefault(_apiCallDebugTransform);
  ...
  _createClass(InspectorWrapper, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['lib', 'actionsById']);

      var tabs = void 0;
      if (lib === 'redux') {
        tabs = function tabs() {
          return [].concat(DEFAULT_TABS, [{ name: 'Mock', component: _MockTab2.default }, { name: 'Trace', component: _reduxDevtoolsTraceMonitor2.default }, { name: 'Test', component: _TestTab2.default }]);
        };
      } else {
        tabs = function tabs() {
          return DEFAULT_TABS;
      ...
      var previewActions = Object.keys(actionsById).reduce(function (actions, id) {
        return _extends({}, actions, _defineProperty({}, id, _extends({}, actionsById[id], {
          action: (0, _apiCallDebugTransform2.default)(actionsById[id].action)
        })));
      }, {});
